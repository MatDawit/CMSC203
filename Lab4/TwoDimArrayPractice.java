...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public void printArray( )
   {
    ...
    // Write your code here:
	   for (int arrayRow = 0; arrayRow < intArray.length; arrayRow++) {
		   for (int arrayColumn = 0; arrayColumn < intArray[arrayRow].length; arrayColumn++) {
	        System.out.print(intArray[arrayRow][arrayColumn] + " ");
	        animate(arrayRow, arrayColumn);
	      }
	   	}
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    //  and column is the index of the array's current column
    // Write your code here:
	   for (int arrayColumn = 0; arrayColumn < intArray[row].length; arrayColumn++) {
	        intArray[row][arrayColumn] = value;
	        animate(row, arrayColumn );
	      }
	   }
   ...
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   ...
	   for (int arrayRow = 0; arrayRow < intArray.length; arrayRow++) {
	      ...
	      if(intArray[arrayRow][column] < minimum) {
	        minimum = intArray[arrayRow][column];
	      }
	      animate(arrayRow, column, minimum );
	    }
	    return minimum;
   }
   ...
   public int countFound( int value )
   {
    ...
    // Write your code here:
	   int count = 0;
	    for (int arrayRow = 0;arrayRow < intArray.length;arrayRow++) {
	      for (int arrayColumn = 0; arrayColumn < intArray[arrayRow].length; arrayColumn++) {
	        if(intArray[arrayRow][arrayColumn]==value) {
	          count++;
	        }
	        animate(arrayRow, arrayColumn, value);
	      }
	    }
